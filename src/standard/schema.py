...
FIELD_DESCRIPTIONS = {
    ...
    "capacity_mw": "Installed generator capacity in MW.",
    ...
    "chp": "Whether the generator asset provides combined heat and power.",
    "ccs": "Whether the generator asset uses carbon capture and storage.",
